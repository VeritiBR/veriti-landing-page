...
export function Plans() {
  ...
  const plans = [
    {
      ...
      description:
        "Ideal para pequenas empresas e MEIs que precisam dos serviços essenciais",
      popular: false,
    ...
    },
    {
      ...
      description:
        "Solução completa para empresas que precisam de consultoria especializada",
      popular: false,
  ...
  const renderFeatureValue = (value: boolean | string) => {
    ...
    return (
      <span className="text-sm text-center text-gray-700 px-2">{value}</span>
    );
  };
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center mb-16">
          ...
          <p className="text-xl text-gray-600 leading-relaxed">
            ...
            atendimento personalizado e tecnologia de ponta para manter sua
          ...
          {plans.map((plan, index) => (
            ...
            >
              ...
              <CardHeader className="text-center pb-6">
                ...
                <CardDescription className="text-lg font-medium text-gray-600 mb-4">
                  {plan.subtitle}
                </CardDescription>
              ...
              <table className="w-full">
                <thead>
                  <tr className="bg-gray-50">
                    <th className="text-left py-4 px-6 font-semibold text-gray-900 w-1/3">
                      Funcionalidades
                    </th>
                      ...
                      {category.features.map((feature, featureIndex) => (
                        ...
                        >
                          ...
                          <td className="py-4 px-6 text-center">
                            {renderFeatureValue(feature.initium)}
                          </td>
                          <td className="py-4 px-6 text-center">
                            {renderFeatureValue(feature.gradus)}
                          </td>
                          <td className="py-4 px-6 text-center">
                            {renderFeatureValue(feature.virtus)}
                          </td>
                        </tr>
                      ))}
                    </React.Fragment>
        ...
        <div className="text-center mt-16">
          <p className="text-lg text-gray-600 mb-6">
            Não tem certeza de qual plano escolher? <br />
            Fale conosco!
          </p>
          <Button
            asChild
